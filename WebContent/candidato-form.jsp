...
<jsp:include page="cabecalho.jsp">
	...
	<form name="candidato" id="contactForm" action="candidato" method="post">
       ...
       <div class="row control-group">
           <div class="form-group col-xs-12 floating-label-form-group controls">
               <label>Número</label>
               <input type="text" name="numero" value="${candidato.numero}" class="form-control" placeholder="Número" id="numero" required data-validation-required-message="Informe o número">
               <p class="help-block text-danger"></p>
           </div>
       </div>
       <br>
